...
const Items = () => {
  ...
  return (
    <>
    <Toaster />
    <div className={`card-container`} style={{ display: selectedItem ? 'none' : 'flex' }}>
      {items.map(item => (
      ...
      <div className='one-item'>
          ...
          <div className="product-actions">
              ...
              <div style={{display: 'flex', justifyContent: "center", alignItems:'center', flexDirection:'column'}}>
                ...
                <button className="add-to-cart-button" onClick={handleAddToCart} disabled={getMaxQuantity(selectedItem) === 0}>Add to Cart</button>
